...
*/
    ...
    public function load(ManiaControl $maniaControl)
    {
        ...
        $this->maniaControl->getCommandManager()->registerCommandListener(
            'modolist',
            $this,
            'onCommandModoPlayersList',
            true,
            'Show last players writing in the chat'
        );

        $this->maniaControl->getCommandManager()->registerCommandListener(
            'saveguestlist',
            $this,
            'onCommandSaveGuestList',
            true,
            'Save the guestlist into one file'
        );

        $this->maniaControl->getCommandManager()->registerCommandListener(
            'saveblacklist',
            $this,
            'onCommandSaveBlackList',
            true,
            'Save the blacklist into one file'
        );

        $this->maniaControl->getCommandManager()->registerCommandListener(
            'loadguestlist',
            $this,
            'onCommandLoadGuestList',
            true,
            'Load the guestlist from one file'
        );

        $this->maniaControl->getCommandManager()->registerCommandListener(
            'loadblacklist',
            $this,
            'onCommandLoadBlackList',
            true,
            'Load the blacklist from one file'
        );
